#USE THE ONE IN cogvideox factory its more up to date and bell and whistles
...
#     >>> lora_paths=glob.glob('/root/CleanCode/Github/CogVideo/finetune/*/*/saved_weights_copy/pytorch_lora_weights.safetensors')
...
if 'pipe' not in vars():
	...
	pipe = get_pipe(
		pipe_id = 'T2V5B', 
		lora_path = '/root/CleanCode/Github/CogVideo/finetune/cogvideox5b-lora-single-node-delegator-noisewarp-Oct16-RandomDegradation-LargerBatchSize-SmallLearnRate/checkpoint-9600/saved_weights_copy/pytorch_lora_weights.safetensors',
		device = 0,
	)
